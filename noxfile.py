...
def codeqa(session: nox.Session):
    ...
    session.run("flake8", "src/antsibull_docs", "src/sphinx_antsibull_ext", *session.posargs)
    session.run("pylint", "--rcfile", ".pylintrc.automated", "src/antsibull_docs", "src/sphinx_antsibull_ext")
