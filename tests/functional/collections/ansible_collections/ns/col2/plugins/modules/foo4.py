...
options:
    existing:
        description:
            ...
            - RV(ns2.col.bar#test:stat._value)
            - M(ns.col2.foo)
            - P(ns.col2.foo2#module)
            - O(ns.col2.foo#module:subfoo.foo)
            - RV(ns.col2.foo#module:baz)
            - M(ext.col.foo)
    ...
    not_existing:
        description:
            ...
            - RV(ns2.col.joo#test:stat._value)
            - M(ns.col2.foobarbaz)
            - P(ns.col2.foobarbam#filter)
            - O(ns.col2.foo#module:barbazbam.foo)
            - RV(ns.col2.foo#module:bambazbar)
