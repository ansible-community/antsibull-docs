...
""",
    ...
    assert stdout == [
        ...
        f'{foo_rst}:9:5: Label "ansible_collections.foo.bar.bad_label" does not start with expected prefix "ansible_collections.foo.bar.docsite."',
...
TEST_CASES: list[
    ...
    (
        ...
        [
            ...
            'docs/docsite/rst/filter_guide.rst:6:5: Label "bad_label" does not start with expected prefix "ansible_collections.ns.col2.docsite."',
            ...
            "roles/extra/meta/argument_specs.yml:0:0: 63 validation errors for RoleSchema",
    ...
    (
        ...
        [
            ...
            "docs/docsite/rst/filter_guide.rst:60:0: :ansretval:`ns2.col.foo#filter:does_not_exist`: return value name does not reference to an existing return value of the filter plugin ns2.col.foo",
            "docs/docsite/rst/filter_guide.rst:62:0: :ansretval:`ns2.col.foo#role:does_not_exist:neither`: the role ns2.col.foo has no entrypoint does_not_exist",
            "docs/docsite/rst/filter_guide.rst:64:0: :ansretval:`ns2.col.foo#role:does_not_exist`: Role reference is missing entrypoint",
            "docs/docsite/rst/filter_guide.rst:66:0: :ansoptref:`no explicit title`: An explicit reference title must be provided!",
            "docs/docsite/rst/filter_guide.rst:68:0: :ansoptref:`title <no plugin>`: Cannot extract plugin name and type",
            "docs/docsite/rst/filter_guide.rst:70:0: :ansoptref:`plugin does not exist <ns2.col.boo#filter:boo>`: there is no filter plugin ns2.col.boo",
            'docs/docsite/rst/filter_guide.rst:72:0: :ansoptref:`entrypoint for non-role <ns2.col.foo#filter:foo:boo>`: Invalid option name "foo:boo"',
            "docs/docsite/rst/filter_guide.rst:74:0: :ansoptref:`no entrypoint for role <ns2.col.foo#role:boo>`: Role reference is missing entrypoint",
            "docs/docsite/rst/filter_guide.rst:76:0: :ansoptref:`invalid entrypoint for role <ns2.col.foo#role:boo:boo>`: the role ns2.col.foo has no entrypoint boo",
            "docs/docsite/rst/filter_guide.rst:78:0: :ansoptref:`option does not exist <ns2.col.foo#filter:boo>`: option name does not reference to an existing option of the filter plugin ns2.col.foo",
            "docs/docsite/rst/filter_guide.rst:80:0: :ansretvalref:`no explicit title`: An explicit reference title must be provided!",
            "docs/docsite/rst/filter_guide.rst:82:0: :ansretvalref:`title <no plugin>`: Cannot extract plugin name and type",
            "docs/docsite/rst/filter_guide.rst:84:0: :ansretvalref:`plugin does not exist <ns2.col.boo#filter:boo>`: there is no filter plugin ns2.col.boo",
            'docs/docsite/rst/filter_guide.rst:86:0: :ansretvalref:`entrypoint for non-role <ns2.col.foo#filter:foo:boo>`: Invalid return value name "foo:boo"',
            "docs/docsite/rst/filter_guide.rst:88:0: :ansretvalref:`no entrypoint for role <ns2.col.foo#role:boo>`: Role reference is missing entrypoint",
            "docs/docsite/rst/filter_guide.rst:90:0: :ansretvalref:`invalid entrypoint for role <ns2.col.foo#role:boo:boo>`: the role ns2.col.foo has no entrypoint boo",
            "docs/docsite/rst/filter_guide.rst:92:0: :ansretvalref:`return value does not exist <ns2.col.foo#filter:boo>`: return value name does not reference to an existing return value of the filter plugin ns2.col.foo",
        ],
    ),
    (
