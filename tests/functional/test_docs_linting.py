...
TEST_CASES = [
    (
        ...
        [
            ...
            "docs/docsite/links.yml:0:0: communication -> irc_channels -> 0 -> extra: extra fields not permitted (type=value_error.extra)",
            "docs/docsite/links.yml:0:0: communication -> mailing_lists -> 0 -> extra: extra fields not permitted (type=value_error.extra)",
            "docs/docsite/links.yml:0:0: communication -> mailing_lists -> 0 -> name: extra fields not permitted (type=value_error.extra)",
            "docs/docsite/links.yml:0:0: communication -> mailing_lists -> 0 -> topic: field required (type=value_error.missing)",
            "docs/docsite/links.yml:0:0: communication -> mailing_lists -> 0 -> url: field required (type=value_error.missing)",
            "docs/docsite/links.yml:0:0: communication -> matrix_rooms -> 0 -> extra: extra fields not permitted (type=value_error.extra)",
            "docs/docsite/links.yml:0:0: communication -> matrix_rooms -> 0 -> name: extra fields not permitted (type=value_error.extra)",
            "docs/docsite/links.yml:0:0: communication -> matrix_rooms -> 0 -> topic: field required (type=value_error.missing)",
            "docs/docsite/links.yml:0:0: edit_on_github -> extra: extra fields not permitted (type=value_error.extra)",
            ...
            "docs/docsite/links.yml:0:0: extra: extra fields not permitted (type=value_error.extra)",
